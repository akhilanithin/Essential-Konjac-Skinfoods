                        ...
                        <div className="col-lg-3 col-contact col-md-6">
                            <div className="widget widget-contact">
                                ...
                                <ul className="widget-body">
                                    ...
                                    <li>
                                        <label>Email</label>
                                        <ALink href="mailto:support@essentialkonjacskinfoods.com">support@essentialkonjacskinfoods<br/>.com</ALink>
                                    </li>
                                    <li>
                                        <label>Address</label>
                        ...
                        <div className="col-lg-4">
                            <div className="widget widget-newsletter form-wrapper">
                                <div className="newsletter-info">
                                    ...
                                    <p>Subscribe to the EKSFC Newsletter. Receive timely updates from your favourite products.</p>
                                </div>
                                <form action="#" className="input-wrapper input-wrapper-inline">
                                    <input 
                                        ...
                                        required 
                                    />
                                    <button className="btn btn-primary btn-rounded btn-md ls-normal ml-2" type="submit">
