...
interface SmallCollectionProps {
    featured?: Product[];
    latest?: Product[];
    bestSelling?: Product[];
    onSale?: Product[];
...
const SmallCollection: React.FC<SmallCollectionProps> = (props) => {
                                ...
                                <div className="products-col">
                                    {
                                        loading ? (
                                            ...
                                            onSale?.slice(0, 3).map((item, index) => (
                                                <SmallProduct
                                                    product={item}
                                ...
                                <div className="products-col">
                                    {
                                        loading ? (
                                            ...
                                            bestSelling?.slice(0, 3).map((item, index) => (
                                                <SmallProduct
                                                    product={item}
