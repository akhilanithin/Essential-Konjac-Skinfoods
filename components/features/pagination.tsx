                ...
                <ul className="pagination">
                    <li className={`page-item ${page < 2 ? 'disabled' : ''}`}>
                        <ALink
                            ...
                            href={page > 1 ? { pathname: router.pathname, query: { ...query, page: page - 1 } } : '#'}
                            scroll={false}
                        >
                        ...
                        (index === 1 && item > 2) ? (
                            <React.Fragment key={`page-${index}`}>
                                ...
                                <li className={`page-item ${page === item ? 'active' : ''}`}>
                                    <ALink
                                        className="page-link"
                                        href={page === item ? '#' : { pathname: router.pathname, query: { ...query, page: item } }}
                                        scroll={false}
                                    >
                    ...
                    <li className={`page-item ${page > totalPage - 1 ? 'disabled' : ''}`}>
                        <ALink
                            ...
                            href={page < totalPage ? { pathname: router.pathname, query: { ...query, page: page + 1 } } : '#'}
                            scroll={false}
                        >
