                            ...
                            <div className="row">
                                <div className="col-md-6 mt-10">
                                    ...
                                    <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                                        <Card title="How can I add vendor role to the customer?" expanded={true}>
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>

                                        <Card title="What benefits can a customer take?">
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                ...
                                <div className="col-md-6 mt-10">
                                    ...
                                    <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                                        <Card title="What is the difference between simple & variable product?" expanded={true}>
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                        ...
                                        <Card title="How to add a downloadable product?">
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                    </Accordion>
                                </div>
                            ...
                            <div className="row">
                                <div className="col-md-6 mt-10">
                                    ...
                                    <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                                        ...
                                        <Card title="What is the benefit of PayPal payment?">
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                        <Card title="How to register as a customer?">
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                        <Card title="What is the preferable way to buy a product?">
                                ...
                                <div className="col-md-6 mt-10">
                                    ...
                                    <Accordion adClass="accordion-border accordion-boxed accordion-plus">
                                        <Card title="How can I return a purchased item online?" expanded={true}>
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
                                        <Card title="How to add a coupon code?">
                                            <p className="mb-0">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</p>
                                        </Card>
