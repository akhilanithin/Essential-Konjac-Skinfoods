...
const Order: React.FC<Props> = ({ cartList }) => {
    return (
            ...
            <div className="page-content pt-7 pb-10 mb-10">
                ...
                <div className="container mt-8">
                    ...
                    <div className="order-results">
                        ...
                        <div className="overview-item">
                            <span>Total:</span>
                            <strong>AED {toDecimal(getTotalPrice(cartList))}</strong>
                        </div>
                        <div className="overview-item">
                            ...
                            <tbody>
                                {cartList.map((item) => (
                                    <tr key={`order-${item.name}`}>
                                        ...
                                        <td className="product-price">AED {toDecimal(item.qty * item.price)}</td>
                                    </tr>
                                ))}
                                <tr className="summary-subtotal">
                                    <td>
                                    ...
                                    <td className="summary-subtotal-price">AED {toDecimal(getTotalPrice(cartList))}</td>
                                </tr>
                                <tr className="summary-subtotal">
                                    <td>
                                ...
                                <tr className="summary-subtotal">
                                    ...
                                    <td>
                                        <p className="summary-total-price">AED {toDecimal(getTotalPrice(cartList))}</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
