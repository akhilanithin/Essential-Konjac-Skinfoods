                ...
                <div className="container">
                    <section className="mt-10 pt-3">
                        <div className="title-wrapper">
                            ...
                            <p className="text-body text-center mb-2">
                                We provide some basic styling to header tags. For example,<br /> you can see 6 header tags' different sizes.
                            </p>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <blockquote className="text-bd-left">
                                    <p>Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris.
                                    Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu
                                    eget nulla. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</p>
                                </blockquote>
                            </div>
                        </div>
                    </section>
