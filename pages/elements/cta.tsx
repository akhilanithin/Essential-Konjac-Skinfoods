...
const Cta: React.FC = () => {
    ...
    return (
        <>
            ...
            <h1 className="d-none">Call To Action</h1>
            ...
            <div className="page-content">
                        ...
                        <div className="banner cta-simple">
                            <div className="banner-content bg-white d-lg-flex align-items-center">
                                ...
                                <div className="banner-text mb-lg-0 mb-4 mr-lg-4 pl-lg-6 pr-lg-0 pl-2 pr-2">
                                    <h4 className="font-weight-normal ls-normal text-uppercase mb-0">Get a Riode gift card + 25% off</h4>
                                    <p className="ls-m mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                                </div>
                                <ALink href="#" className="btn btn-primary btn-ellipse btn-md btn-rounded">Shop Now<i className="d-icon-arrow-right"></i></ALink>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col-md-6 mb-4">
                                <div className="banner banner-1 banner-fixed content-center content-middle">
                                    ...
                                    <div className="banner-content">
                                        <h3 className="banner-title text-uppercase font-weight-bold ls-m text-primary">20% off</h3>
                                        <h4 className="banner-subtitle font-weight-bold ls-m text-white">Riode Birthday Sale</h4>
                                        <p className="ls-s text-light">Get all the latest information on <br />Events, Sales and Offers.</p>
                                ...
                                <div className="banner banner-2 banner-fixed content-center content-middle">
                                    ...
                                    <div className="banner-content">
                                        <h3 className="banner-title text-uppercase font-weight-normal ls-m text-white mb-3">
                                            Subscribe to our<br /><strong>Newsletter</strong>
                                        </h3>
                                        ...
                                        <form action="#" method="get" className="input-wrapper">
                                            <input type="email" className="form-control w100 text-white text-center mb-4"
                                                ...
                                                required />
                                            <button className="btn btn-white btn-md btn-ellipse btn-rounded" type="submit">Subscribe<i className="d-icon-arrow-right"></i></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-4 col-sm-6 mb-4 order-lg-auto order-sm-last">
                                <div className="banner banner-4 banner-fixed banner-radius content-middle content-center">
                                    ...
                                    <div className="banner-content d-flex align-items-center w-100 text-left">
                                        ...
                                        <ALink href="/shop" className="btn btn-primary btn-outline font-weight-bold text-white btn-rounded">Shop Now<i className="d-icon-arrow-right"></i></ALink>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="mt-10">
                    <div className="container">
                        ...
                        <div className="banner banner-newsletter bg-white">
                                ...
                                <div className="col-xl-5 col-lg-6">
                                    <div className="icon-box icon-box-side mb-4 mb-lg-0">
                                        ...
                                        <div className="icon-box-content">
                                            ...
                                            <p className="text-dark">Get all the latest information on Events, Sales and Offers.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-xl-7 col-lg-6 d-lg-block d-flex justify-content-center">
                                    <form action="#" method="get" className="input-wrapper input-wrapper-round input-wrapper-inline ml-lg-auto">
