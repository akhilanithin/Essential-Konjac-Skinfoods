    ...
    return (
        <>
            ...
            <div className="page-content">
                    ...
                    <div className="container">
                        ...
                        <OwlCarousel adClass="owl-theme" options={mainSlider6}>
                            <div className="testimonial">
                                <blockquote>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu ante eget nisl convallis tempus Phsellus anctus, tincidunt tincidunt dui.</blockquote>
                        ...
                        <OwlCarousel adClass="owl-theme" options={mainSlider6}>
                            <div className="testimonial testimonial-centered">
                                <div className="testimonial-info">
                                    ...
                                    <blockquote>“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque ”</blockquote>
                                    <cite>
                                        Herman Beck
                                        <span>Customer</span>
                                    </cite>
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-6">
                                <OwlCarousel adClass="owl-nav-bottom" options={mainSlider7}>
                                    <div className="testimonial">
                                        <blockquote>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu ante eget nisl convallis tempus Phsellus anctus, tincidunt tincidunt dui.met, consectetur adipiscing elit. Sed eu ante eget nisl dolor sit amet.</blockquote>
                                        <div className="testimonial-info">
                                            <figure className="testimonial-author-thumbnail">
                                                <img src="./images/agents/1.jpg" alt="user" width={50} height={50} />
                                            </figure>
                ...
                <section className="pt-10 pb-10 parallax" style={{ backgroundImage: "url('./images/banner.jpg')" }}>
                        ...
                        <OwlCarousel adClass="owl-theme owl-dot-white" options={mainSlider4}>
                            <div className="testimonial testimonial-centered testimonial-bg">
                                <div className="testimonial-info">
                                    ...
                                    <blockquote>“ Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci. Aenean dignissim pellentesque felis. Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in, pharetra ”</blockquote>
                                    <cite>
                                        Charly Simth
                                        <span>Customer</span>
                                    </cite>
