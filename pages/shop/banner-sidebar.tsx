...
const ShopBannerSidebar: React.FC = () => {
    return (
        <main className="main">
            <Helmet>
                        ...
                        <div className="col-lg-9 main-content">
                            <div className="shop-banner-default banner mb-1" style={{ backgroundImage: "url('./images/shop/banner.jpg')", backgroundColor: "#f2f2f3" }}>
                                <div className="banner-content">
                                    ...
                                    <ALink href="/shop" className="btn btn-white btn-outline btn-icon-right btn-rounded text-normal">
                                        Discover now<i className="d-icon-arrow-right"></i>
                                    </ALink>
                                </div>
                            </div>
